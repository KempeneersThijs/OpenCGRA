...
def test_Systolic3x3():
  target_json = "systolic3x3.json"
  script_dir  = os.path.dirname(__file__)
  file_path   = os.path.join( script_dir, target_json )

  II                = 8 # 1 extra cycle due to memory loading of the bottom tiles
  num_tile_inports  = 4
  num_tile_outports = 4
  num_xbar_inports  = 6
  num_xbar_outports = 8
  ctrl_mem_size     = 8
  width             = 3
  height            = 4 # 2 bottom tiles used for loading elements from memory
  ...
  Limits of this implementation:
    ...
    - b, c and k have to be multiples of the array width (in this case 3). This means that if you imagine a tile
      of the array size (3x3 in this case), this tile has to be able to fit a whole number of times inside both
